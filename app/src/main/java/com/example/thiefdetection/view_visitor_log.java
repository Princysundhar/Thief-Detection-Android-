...
public class view_visitor_log extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        url = sh.getString("url","")+"android_view_visitorlog";
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for (int i = 0; i < js.length(); i++) {
                                    ...
                                    vid[i] = u.getString("vid"); // dbcolumn name in double quotes
                                ...
                                li.setAdapter(new custom_view_visitor_log(getApplicationContext(),vid,image,date,time));//custom_view_service.xml and li is the listview object
