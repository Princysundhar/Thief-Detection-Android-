    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                String camera_no = e1.getText().toString();
                int flag = 0;
                if(camera_no.equalsIgnoreCase("")){
                    e1.setError("Enter camera number");
                    flag ++;
                }
                if(flag == 0){
                    sh = PreferenceManager.getDefaultSharedPreferences(getApplicationContext());
                    sh.getString("ip","");
                    url = sh.getString("url","")+"android_add_camera";
                    ...
                    StringRequest postRequest = new StringRequest(Request.Method.POST, url,
                                ...
                                public void onResponse(String response) {
                                    ...
                                    try {
                                        ...
                                        if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                            Toast.makeText(add_camera.this, "camera added", Toast.LENGTH_SHORT).show();
                        ...
                        protected Map<String, String> getParams() {
                            ...
                            params.put("camera_no", camera_no);
